<template>
  <div class="w-full h-full bg-white rounded-3xl shadow-lg">
    <!-- 用户头像和操作按钮 -->
    <div class="relative p-6">
      <div class="flex justify-between items-start mb-4">
        ...
        <div class="flex items-end gap-2">
          <button class="bg-gradient-to-r from-purple-400 to-purple-600 text-white px-4 py-0.5 rounded-full text-sm">
            {{ isOwner ? '编辑个人资料' : '关注' }}
          </button>
          <MessageCircleMore v-if="!isOwner" :size="24" />
        </div>
      </div>
